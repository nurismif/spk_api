              ...
              <div class="container-table100">
                  ...
                  <form class="form-inline" action="?m=rel_kriteria" method="post">
                    <div class="form-group" style="padding-right: 10px;">
                      <select class="form-control" name="ID1">
                        <option value="C01">C01 - Umum</option><option value="C02">C02 - Teman</option><option value="C03">C03 - Peserta Didik</option><option value="C04">C04 - Wali Murid</option><option value="C05">C05 - Dunia Industri</option>        </select>
                    </div>
                    <div class="form-group" style="padding-right: 10px;">
                    ...
                    <div class="form-group" style="padding-right: 10px;">
                      <button class="btn btn-primary"><span class="glyphicon glyphicon-edit"></span> Ubah
                      </button></div>
                  </form>
                </div>
                ...
                <table class="table table-bordered table-hover table-striped">
                  <thead>
                      <tr>
                          <th>Kode</th>
                          <th>C01</th><th>C02</th><th>C03</th><th>C04</th><th>C05</th>    </tr>
                  </thead>
                  <tbody>
                  <tr>
                      <th>C01</th>
                      <td>1</td><td>1</td><td>3</td><td>1</td><td>3</td></tr>
                  <tr>
                      <th>C02</th>
                      <td>1</td><td>1</td><td>2</td><td>1</td><td>1</td></tr>
                  <tr>
                      <th>C03</th>
                      <td>0.333</td><td>0.5</td><td>1</td><td>1</td><td>2</td></tr>
                  <tr>
                      <th>C04</th>
                      <td>1</td><td>1</td><td>1</td><td>1</td><td>3</td></tr>
                  <tr>
                      <th>C05</th>
                      <td>0.333</td><td>1</td><td>0.5</td><td>0.333</td><td>1</td></tr>
                  </tbody>
                  </table>
